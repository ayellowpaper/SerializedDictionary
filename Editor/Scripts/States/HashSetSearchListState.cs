...
{
    internal class HashSetSearchListState : HashSetListState
    {
        ...
        public HashSetSearchListState(SerializedHashSetInstanceDrawer serializedHashSetDrawer) : base(serializedHashSetDrawer)
        {
        }

        public override void DrawElement(Rect rect, SerializedProperty property, DisplayType displayType)
        {
            SerializedHashSetInstanceDrawer.DrawElement(rect, property, displayType, BeforeDrawingProperty, AfterDrawingProperty);
        }
